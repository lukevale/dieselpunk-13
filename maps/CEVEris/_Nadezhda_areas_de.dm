...
/area/nadezhda/absolutism/monistary
	name = "\improper Orden Monistary"
...
/area/nadezhda/security/blackshield
	name = "Black Shield Compound"
	icon_state = "blackguard"
	ambience = list('sound/ambience/ambimo1.ogg', 'sound/ambience/ambimo2.ogg')
	dynamic_lighting = TRUE
	requires_power = 0

/area/nadezhda/security/blackshieldu
	name = "Black Shield Compound"
	icon_state = "blackguard"
	dynamic_lighting = TRUE
	requires_power = 0
