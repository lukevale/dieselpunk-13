...
#define JOBS_COMMAND "Premier","Steward","Blackshield Commander","Warrant Officer","Chief Executive Officer","Guild Master","Chief Biolab Overseer","Chief Research Overseer","Confessor"
...
#define JOBS_LSS "Chief Executive Officer","Cargo Technician","Lonestar Miner","Bartender","Chef","Gardener","Artist"
#define JOBS_CIVILIAN "Colonist"
#define JOBS_CHURCH "Confessor", "Chaplain","Janitor"
